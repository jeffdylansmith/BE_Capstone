var olp=0;$("#sortable").sortable({start:function(n,t){olp=t.item.index()},update:function(n,t){let i=olp,r=t.item.index();var u=document.getElementById("help").value;$.ajax({url:`/project/updateSceneOrder/${u}`,type:"POST",data:{newIndex:r,oldIndex:i},dataType:"application/json",success:function(n){console.log(n);console.log(n.success)}});document.location.reload()}});$(".lineSortable").sortable({start:function(n,t){olp=t.item.index()},update:function(n,t){let i=olp,r=t.item.index();var u=document.getElementById("help").value;$.ajax({url:`/scene/updateLineOrder/${u}`,type:"POST",data:{newIndex:r,oldIndex:i},dataType:"application/json",success:function(n){console.log(n);console.log(n.success)}});document.location.reload()}});$("#sortable").disableSelection();
