var olp=0;$("#sortable").sortable({start:function(n,t){olp=t.item.index();console.log("start: "+t.item.index())},update:function(n,t){let u=olp,i=t.item.index();var r=document.getElementById("help").value;console.log("ProjectId: "+r);console.log("New position: "+i);$.ajax({url:`/project/updateSceneOrder/${r}`,type:"POST",data:{newIndex:i,oldIndex:u},dataType:"application/json",success:function(n){console.log(n);console.log(n.success)}});document.location.reload()}});$("#sortable").disableSelection();
